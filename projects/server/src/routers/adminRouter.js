...
const { login, keeplogin, adminRegister, adminList, adminEdit, adminDelete, adminReset, adminBranchList } = require('../Controllers/adminController');
...
route.get('/adminbranchlist', readToken, adminBranchList);
